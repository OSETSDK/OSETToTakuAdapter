Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    ...
                    DESC
  s.homepage     = "https://github.com/OSETSDK/OSETToTakuAdapter"
  ...
  # 源文件配置
  s.source       = {
    :git => 'https://github.com/OSETSDK/OSETToTakuAdapter.git',
    :tag => s.version.to_s
  }
  # 主框架文件
  # 检查 OSETToBidAdapter.podspec 关键字段
  s.source_files = 'OSETToTakuAdapter/**/*.{h,m}'
  # 系统框架依赖
  ...
  s.dependency 'OSETCoreSDK','>=6.6.0.7'
